...
prediction.py covers the genome prediction using BRAKER3 or GALBA depending on if high quality RNA data is provided
...
These scripts, along with a brief description can be found in the helper_scripts/ directory
